...
<!-- TYPING ANIMATION -->
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3500&pause=1000&color=60A5FA&center=true&vCenter=true&width=1200&lines=Dinusha+Priyashan;Final+Year+Data+Science+Undergraduate+%7C+University+of+Colombo;Data+Visualization+%7C+Power+BI+%7C+Business+Analytics;Machine+Learning+%7C+Deep+Learning+%7C+Natural+Language+Processing;Statistical+Inference+%7C+Causal+Inference;Multivariate+Data+Analysis+%7C+Time+Series+Analysis;Big+Data+Analytics+%7C+Database+Management;Transforming+Data+into+Insights+and+Impact" alt="Typing SVG"/>
</div>
...
- 📊 Data Visualization & Business Intelligence (Power BI, Excel)
...
- Transformer Models & NLP Applications
...
To leverage data science, machine learning, and analytics to solve real-world problems and create impactful, data-driven solutions.
